...
<body>
    ...
    <!-- Conteiner Fluid para abrigar o logo tipo -->
    <div class="container-fluid text-danger text-center mt-3">
        <img src="img/logo_loja.jpg" width="150">
        <h1 style="font-family: Black And White Picture">MISTURA FINA</h1>
    </div>
    ...
    <!-- container que abrigara o conteúdo da página-->
